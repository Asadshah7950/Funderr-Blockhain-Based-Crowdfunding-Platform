      ...
      <View style={styles.cardContent}>
        ...
        <View style={styles.statsRow}>
          <View style={styles.statItem}>
            <Text style={styles.statValue}>{formatCurrency(campaign.amountRaised || 0)}</Text>
            <Text style={styles.statLabel}>raised</Text>
          </View>
          <View style={styles.statDivider} />
          <View style={styles.statItem}>
            <Text style={styles.statValue}>{formatCurrency(campaign.goal || 0)}</Text>
...
const ExploreCampaignsScreen = ({ navigation }) => {
  ...
  // Refresh campaigns when screen comes into focus (after donation)
  useFocusEffect(
    useCallback(() => {
      fetchCampaigns();
    }, [])
